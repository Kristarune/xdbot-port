...
#define DEFAULT_RESULT_ERROR geode::Err("Event was not handled")
    ...
    class CreateRecorderEvent : public geode::DispatchEvent<CreateRecorderEvent> {
    public:
    ...
    class DeleteRecorderEvent : public geode::DispatchEvent<DeleteRecorderEvent> {
    public:
    ...
    class InitRecorderEvent : public geode::DispatchEvent<InitRecorderEvent> {
    public:
    ...
    class StopRecorderEvent : public geode::DispatchEvent<StopRecorderEvent> {
    public:
    ...
    class GetWriteFrameFunctionEvent : public geode::DispatchEvent<GetWriteFrameFunctionEvent> {
    public:
    ...
    class CodecRecorderEvent : public geode::DispatchEvent<CodecRecorderEvent> {
    public:
    ...
    class MixVideoAudioEvent : public geode::DispatchEvent<MixVideoAudioEvent> {
    public:
    ...
    class MixVideoRawEvent : public geode::DispatchEvent<MixVideoRawEvent> {
    public:
